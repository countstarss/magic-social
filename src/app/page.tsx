...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col min-h-[100vh]">
      <header className="px-4 mt-5 lg:p-6 h-14 flex items-center">
      ...
      <main className="flex-1">
        <section className="w-full p-8 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto mt-10 grid max-w-5xl items-start gap-6 py-12 lg:grid-cols-3 lg:gap-12">
              ...
              <div className="grid gap-4">
                <div className="flex items-start gap-4">
                  {/* <div className="rounded-full bg-primary p-2 text-primary-foreground"></div>s */}
                  <div>
